...
class _HomePageState extends State<HomePage> {
  var pokedexApi = "https://raw.githubusercontent.com/Biuni/PokemonGO-Pokedex/master/pokedex.json";
      ...
      body: Stack(
        ...
        children: [
          ...
          Positioned(
            top: -30,
            right: -30,
            child:Image.asset('images/pokemerah.png',width: 160, fit: BoxFit.fitWidth,),
          ),
          Positioned(
            top: 80,
            left: 20,
          ...
          Positioned(
            ...
            child: Column(
            children: [
             pokedex.length != null ?  Expanded(child: GridView.builder(gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2,childAspectRatio: 1.4), itemCount: pokedex.length,
                  ...
                  child: Padding(
                    ...
                    child: Container(
                        decoration: BoxDecoration(
                          ...
                          type == 'Poison' ? Colors.deepPurpleAccent :
                          Colors.pink,
